...
test("Header visual regression test", async ({ page }) => {
  ...
  const baselinePath = resolve("__test__/visual/images/screenshots/header-primary-baseline.png");
  const currentPath = resolve("__test__/visual/images/screenshots/header-primary-current.png");
  const diffPath = resolve("__test__/visual/images/screenshots/header-primary-diff.png");
